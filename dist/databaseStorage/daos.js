...
const MessagesDao_1 = require("./MessagesDao");
...
const messagesClient = new MongoClient_1.MongoClient(Messages_1.Messages);
...
exports.messagesDao = new MessagesDao_1.MessagesDao(messagesClient);
